---
name: Crash report
about: Auto-generated from an app crash (or a manual crash report)
title: '[Crash] '
labels: 'bug,crash'
assignees: ''
---
...
**Crash source:** `(filled by app — e.g. uncaughtException)`
...
**Additional context**
Add any other context about the crash here (what you were doing when it happened, connection type, protocol, etc.).
