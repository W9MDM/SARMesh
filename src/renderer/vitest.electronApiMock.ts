...
export function createElectronAPIMock(): ElectronAPI {
  return {
    ...
    packetMonitor: {
      getSettings: vi.fn().mockResolvedValue(DEFAULT_PACKET_MONITOR_SETTINGS),
      setSettings: vi.fn().mockResolvedValue(DEFAULT_PACKET_MONITOR_SETTINGS),
      query: vi.fn().mockResolvedValue([]),
      stats: vi
        .fn()
        .mockResolvedValue({ rowCount: 0, oldestMs: null, newestMs: null, fileBytes: 0 }),
    ...
    inventory: {
      ...
      exportFile: vi.fn().mockResolvedValue({ cancelled: true }),
      exportCsv: vi.fn().mockResolvedValue({ cancelled: true }),
      importFile: vi.fn().mockResolvedValue({ cancelled: true }),
